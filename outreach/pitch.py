...
_SYSTEM = (
    ...
    "- Cite ONE of the engineer's portfolio projects by name as proof of fit, and "
    "include the portfolio link so they can actually go and read the code. A named "
    "project with no link is an unverifiable claim, which is exactly what every other "
    "cold email in their inbox already contains.\n"
